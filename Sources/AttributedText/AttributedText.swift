...
public struct AttributedText: View {
  ...
  public init(text: String, prefixes: [AttributedPrefix], urlContainer: AttributeContainer, action: @escaping (String, String) -> Void ) {
    ...
    Text(attributedText)
      .environment(\.openURL, OpenURLAction { url in
        ...
        let prefix = prefixes.first {
          ...
          guard prefix.startIndex <= query.endIndex && prefix.endIndex <= query.endIndex  else { return false }
